...
import { registerUserReqSchema, updateUserReqSchema } from "../requests/user-schema.request";
...
export class UserController extends BaseController {
  ...
  updateUserController = async (req: Request, res: Response, next: NextFunction): Promise<Response<any>> => {
    const reqDto = this.validateOrThrow(
      updateUserReqSchema,
      { body: req.body,
        userId: req.userId,
